import { Block, BlockComponentOnPlaceEvent, BlockComponentPlayerInteractEvent, BlockComponentPlayerPlaceBeforeEvent, BlockCustomComponent, BlockPermutation, ItemUseOnAfterEvent, ItemUseOnBeforeEvent, PlayerBreakBlockBeforeEvent, PlayerDimensionChangeAfterEvent, PlayerPlaceBlockAfterEvent, system, world } from "@minecraft/server";
...
export class DoorComponent implements BlockCustomComponent {
    ...
    onPlace(e: BlockComponentOnPlaceEvent) {
        if (
            e.block.permutation.getState("cc:upper_block_bit")
        ) {
            return;
        }
        let hinge = false;
